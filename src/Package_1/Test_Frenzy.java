...
public class Test_Frenzy {
  ...
  @Test(testName = "Abrir Navegador",description="Abrir El Navegador e ir a la URL")
  ...
  @Test(testName = "Login",description="Iniciar Sesión en Frenzy.com.gt")
  ...
  @Test(testName = "Test Navbar",description="Test de Botones del Navbar")
  public void Navbar() throws InterruptedException {
			...
			Thread.sleep(3000);		
			 if(!driver.findElements(By.xpath("//DIV[@class='row flexVerticalCenter justifyContentCenter contentPoints ng-scope']")).isEmpty()){
					...
					Reporter.log("Los Bits No Cargaron");
				}
  ...
  @Test(testName = "Test Botones Navbar",description="Test de Botones de la Pagina Principal:'Go!','¿Donde Consigo El código de Promoción' y '¿Como gano y cambio Bits?'")
  ...
  @Test(testName = "Test Categorias",description="Test de Las Categorias: 'Supermercado','Restaurantes','Moda','Entretenimiento','Electronicos' y 'Otros'. Test Socios y Paginas Web de Socios")
...
//		                Thread.sleep(2000);
		                    ...
		                    if(winNames.length > 1) {
		                        for(w = winNames.length; w > 1; w--) {
		                            ...
		                            if(actualUrl.equals(url)) {
		                            	Reporter.log("Error en URl del socio, Categoria No. " + c + "Socio NO. " + a);
		                            }
		                            driver.close();
		                        }
		                    }
  ...
  @Test(testName = "Test Que Es Frenzy",description="Test Video de Frenzy")
  ...
  @Test(testName = "Test Bits",description="Test de Bits, Promociones y Botones")
  public void Bits() throws InterruptedException {
	//Ir hacia Points
	  WebDriverWait wait = new WebDriverWait(driver,30);
	  String Bits = "https://frenzy.com.gt/#/menu/points";
			Thread.sleep(4500);
  ...
  @Test(testName = "Test Premios",description="Test de Premios")
  ...
  @Test(testName = "Test PlayStore and AppStore",description="Test de Botones de Google Play y AppStore")
	            ...
	            if(winNames.length > 1) {
	                for(w = winNames.length; w > 1; w--) {
	                    ...
	                    if(actualUrl.equals(url)) {
	                    	...
	                    	Reporter.log("Error URL de la Aplicación de PlayStore");
	                    }
	                    driver.close();
	                }
	            }
	            ...
	            if(winNames.length > 1) {
	                for(w = winNames.length; w > 1; w--) {
	                    ...
	                    if(actualUrl.equals(url)) {
	                    	...
	                    	Reporter.log("Eror URL de la Aplicación de AppStore");
	                    }
	                    driver.close();
	                }
	            }
